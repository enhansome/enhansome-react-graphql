...
* [Relay Modern](https://facebook.github.io/relay/): A JavaScript framework for building data-driven React applications
  * [Github](https://github.com/facebook/relay) ⭐ 18,961 | 🐛 861 | 🌐 Rust | 📅 2026-09-10
...
* Code generators:
  * [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,262 | 🐛 558 | 🌐 TypeScript | 📅 2026-09-10: GraphQL code generator with flexible support for custom templates
  * [apollo-codegen](https://github.com/apollographql/apollo-codegen) ⭐ 3,042 | 🐛 364 | 🌐 TypeScript | 📅 2026-09-10: Generate API code or type annotations based on a GraphQL schema and query documents
* Linters:
  * [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 101 | 🌐 JavaScript | 📅 2026-09-10: Check your GraphQL query strings against a schema
...
* ReactJS
  * [Next.js With Apollo](https://github.com/zeit/next.js/tree/master/examples/with-apollo) ⭐ 142,230 | 🐛 3,343 | 🌐 JavaScript | 📅 2026-09-11 - Boilerplate for building Next.js apps with Apollo.
  * [Next.js Serverless with Apollo](https://github.com/hasura/graphql-engine/tree/master/community/sample-apps/nextjs-8-serverless/with-apollo) ⭐ 32,112 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-09-09
...
* React Native
  * [React, Apollo & GraphQL Starter Kits](https://github.com/graphql-boilerplates/react-fullstack-graphql/) ⭐ 1,434 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-10: Fullstack boilerplate project with a database and best practices for authentication, filtering, pagination and
