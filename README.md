...
* [Relay Modern](https://facebook.github.io/relay/): A JavaScript framework for building data-driven React applications
  * [Github](https://github.com/facebook/relay) ⭐ 18,958 | 🐛 858 | 🌐 Rust | 📅 2026-08-28
...
* Code generators:
  ...
  * [apollo-codegen](https://github.com/apollographql/apollo-codegen) ⭐ 3,042 | 🐛 364 | 🌐 TypeScript | 📅 2026-08-28: Generate API code or type annotations based on a GraphQL schema and query documents
* Linters:
...
* ReactJS
  * [Next.js With Apollo](https://github.com/zeit/next.js/tree/master/examples/with-apollo) ⭐ 141,971 | 🐛 3,640 | 🌐 JavaScript | 📅 2026-08-28 - Boilerplate for building Next.js apps with Apollo.
  * [Next.js Serverless with Apollo](https://github.com/hasura/graphql-engine/tree/master/community/sample-apps/nextjs-8-serverless/with-apollo) ⭐ 32,103 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-08-19
