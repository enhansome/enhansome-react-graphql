...
* [Relay Modern](https://facebook.github.io/relay/): A JavaScript framework for building data-driven React applications
  * [Github](https://github.com/facebook/relay) ⭐ 18,956 | 🐛 862 | 🌐 Rust | 📅 2026-08-26
...
* Code generators:
  * [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,265 | 🐛 554 | 🌐 TypeScript | 📅 2026-08-23: GraphQL code generator with flexible support for custom templates
...
* Linters:
  * [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 100 | 🌐 JavaScript | 📅 2026-08-25: Check your GraphQL query strings against a schema
...
* ReactJS
  * [Next.js With Apollo](https://github.com/zeit/next.js/tree/master/examples/with-apollo) ⭐ 141,931 | 🐛 3,726 | 🌐 JavaScript | 📅 2026-08-26 - Boilerplate for building Next.js apps with Apollo.
  * [Next.js Serverless with Apollo](https://github.com/hasura/graphql-engine/tree/master/community/sample-apps/nextjs-8-serverless/with-apollo) ⭐ 32,100 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-08-19
...
* React Native
  * [React, Apollo & GraphQL Starter Kits](https://github.com/graphql-boilerplates/react-fullstack-graphql/) ⭐ 1,431 | 🐛 52 | 🌐 JavaScript | 📅 2026-08-25: Fullstack boilerplate project with a database and best practices for authentication, filtering, pagination and
