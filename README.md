...
* [Relay Modern](https://facebook.github.io/relay/): A JavaScript framework for building data-driven React applications
  * [Github](https://github.com/facebook/relay) ⭐ 18,961 | 🐛 861 | 🌐 Rust | 📅 2026-09-11
...
* Code generators:
  * [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,262 | 🐛 560 | 🌐 TypeScript | 📅 2026-09-12: GraphQL code generator with flexible support for custom templates
...
* ReactJS
  * [Next.js With Apollo](https://github.com/zeit/next.js/tree/master/examples/with-apollo) ⭐ 142,248 | 🐛 3,351 | 🌐 JavaScript | 📅 2026-09-12 - Boilerplate for building Next.js apps with Apollo.
