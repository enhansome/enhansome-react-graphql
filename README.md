...
* [Relay Modern](https://facebook.github.io/relay/): A JavaScript framework for building data-driven React applications
  * [Github](https://github.com/facebook/relay) ⭐ 18,961 | 🐛 860 | 🌐 Rust | 📅 2026-09-09
...
* Code generators:
  * [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,263 | 🐛 559 | 🌐 TypeScript | 📅 2026-09-09: GraphQL code generator with flexible support for custom templates
  * [apollo-codegen](https://github.com/apollographql/apollo-codegen) ⭐ 3,042 | 🐛 364 | 🌐 TypeScript | 📅 2026-09-09: Generate API code or type annotations based on a GraphQL schema and query documents
* Linters:
  * [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 101 | 🌐 JavaScript | 📅 2026-09-09: Check your GraphQL query strings against a schema
...
* ReactJS
  * [Next.js With Apollo](https://github.com/zeit/next.js/tree/master/examples/with-apollo) ⭐ 142,218 | 🐛 3,335 | 🌐 JavaScript | 📅 2026-09-10 - Boilerplate for building Next.js apps with Apollo.
...
* React Native
  * [React, Apollo & GraphQL Starter Kits](https://github.com/graphql-boilerplates/react-fullstack-graphql/) ⭐ 1,434 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-09: Fullstack boilerplate project with a database and best practices for authentication, filtering, pagination and
