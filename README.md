...
* [Relay Modern](https://facebook.github.io/relay/): A JavaScript framework for building data-driven React applications
  * [Github](https://github.com/facebook/relay) ⭐ 18,965 | 🐛 861 | 🌐 Rust | 📅 2026-09-22
...
* Code generators:
  * [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,260 | 🐛 478 | 🌐 TypeScript | 📅 2026-09-20: GraphQL code generator with flexible support for custom templates
...
* ReactJS
  * [Next.js With Apollo](https://github.com/zeit/next.js/tree/master/examples/with-apollo) ⭐ 142,399 | 🐛 3,473 | 🌐 JavaScript | 📅 2026-09-22 - Boilerplate for building Next.js apps with Apollo.
...
* React Native
  * [React, Apollo & GraphQL Starter Kits](https://github.com/graphql-boilerplates/react-fullstack-graphql/) ⭐ 1,434 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-21: Fullstack boilerplate project with a database and best practices for authentication, filtering, pagination and
