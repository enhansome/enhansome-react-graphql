...
* [Relay Modern](https://facebook.github.io/relay/): A JavaScript framework for building data-driven React applications
  * [Github](https://github.com/facebook/relay) ⭐ 18,962 | 🐛 861 | 🌐 Rust | 📅 2026-09-04
...
* Code generators:
  * [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,264 | 🐛 559 | 🌐 TypeScript | 📅 2026-09-07: GraphQL code generator with flexible support for custom templates
...
* ReactJS
  * [Next.js With Apollo](https://github.com/zeit/next.js/tree/master/examples/with-apollo) ⭐ 142,171 | 🐛 3,280 | 🌐 JavaScript | 📅 2026-09-07 - Boilerplate for building Next.js apps with Apollo.
  * [Next.js Serverless with Apollo](https://github.com/hasura/graphql-engine/tree/master/community/sample-apps/nextjs-8-serverless/with-apollo) ⭐ 32,113 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-08-19
